...
#' hierachical nesting and the treatment is not applied at
#' the observation level, but rather at some higher blocking level. 
#' This is a plant response experiment where there are 9 rings, three of which
